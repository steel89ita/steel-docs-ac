---
title: Showroom 06 - Abandoned Warehouse
description: Abandoned Warehouse Showroom
tags: ['showroom']
---

{/* Ext Config INI parts */}
import ExtLightsControl from '!!raw-loader!@site/src/configs/st_06_ext_lights.ini';

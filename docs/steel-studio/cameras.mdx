...
import videoCameraSelection from './video/cameras_selection.mp4';
import videoCameraPathCapture from './video/cameras_path_capture.mp4';
...
<VideoPlayer url={videoCameraSelection} />
...
<VideoPlayer url={videoCameraPathCapture} />
